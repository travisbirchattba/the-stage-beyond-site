...
<div className="textStack">
  <p>
    You can feel it in how you relate to your work.  
    In the questions that don’t go away.  
    In the sense that what brought you here may not carry you forward.
  </p>

  <p>
    Most dancers navigate this quietly — on their own, or in fragments.  
    Piecing together a next step without a place to really work it through.
  </p>

  <p>
    The Stage Beyond exists to make that process shared, visible,
    and something you can actively engage.
  </p>
